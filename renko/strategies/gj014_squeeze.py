"""
GJ014: Squeeze Momentum Breakout — GBPJPY Renko 0.05
...
DESCRIPTION = "Squeeze Momentum breakout — enter on squeeze release with momentum confirmation (GBPJPY)"

HYPOTHESIS = (
    "TTM Squeeze identifies volatility compression -> expansion cycles. GBPJPY "
    "has the highest baseline PF (20.87). Squeeze entries may capture breakout "
    "setups that brick-count misses, adding a complementary entry type."
)
