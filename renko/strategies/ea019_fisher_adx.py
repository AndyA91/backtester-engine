"""
EA019: Fisher Transform Cross + ADX Gate — EURAUD Renko 0.0006

Port of BTC001 Fisher+ADX strategy to EURAUD. Fisher Transform converts price
...
Data: OANDA_EURAUD, 1S renko 0.0006.csv

EURAUD engine calibration:
  Commission: 0.0046% (same as EURUSD baseline).
...
DESCRIPTION = "EURAUD Fisher Transform cross entry with Renko ADX regime gate"

HYPOTHESIS = (
    "Fisher Transform was proven on BTCUSD renko (PF 18.67). EURAUD has 16 "
    "strategies but none use Fisher Transform. Fisher crosses on Renko bricks "
    "may capture different edge from the existing momentum/volume strategies, "
    "adding diversification to the EURAUD portfolio."
)
