"""
R014: Fisher Transform Cross + ADX Gate — EURUSD Renko 0.0004

Port of BTC001 Fisher+ADX strategy to EURUSD. Fisher Transform converts price
...
Optional gates: session_start, vol_max, psar_gate (same as btc001).
...
DESCRIPTION = "EURUSD Fisher Transform cross entry with Renko ADX regime gate"

HYPOTHESIS = (
    "Fisher Transform was proven on BTCUSD renko (PF 18.67). On EURUSD Renko "
    "bricks (0.0004), Fisher crosses should be equally clean — each brick is a "
    "uniform pip move. Adding ADX gate filters choppy-regime false signals."
)
