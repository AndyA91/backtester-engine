"""
USOXXX: Strategy Name

One-line description of the signal logic (LONG ONLY).
"""
...
# ── Stock defaults ────────────────────────────────────────────────────────────
COMMISSION_PCT = 0.0       # zero commission (Schwab/Fidelity/Robinhood)
...
def generate_signals(
    ...
    """
    Generate LONG-ONLY entry/exit signals.
